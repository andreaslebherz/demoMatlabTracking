classdef helperTargetTrackingDisplay < matlab.System
    ...
    methods
        function obj = helperTargetTrackingDisplay(varargin)
            ...
            % Make a figure
            hFigure = figure('Position', [0, 0, 1200, 640], 'Name', 'Multiple Object Tracking Example');
...
function BEP = createBEPPanel(obj, hFigure, position, frontBackLim, sensors, title, isLegend)
    ...
    detectionPlotter(BEP, 'DisplayName','radar', 'Marker','o','MarkerEdgeColor','red','MarkerFaceColor','red','MarkerSize',4);
